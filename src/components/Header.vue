<template>
  <header class="header-wrapper hide-mobile header-pc">
    ...
    <div class="header">
      <a class="logo" @click="goAnchor('#sos', 'sos')">
      ...
      <div class="header-right-area">
        ...
        >
          <span class="el-dropdown-link">
            {{ currentLocal.name }}
            <el-icon
              class="el-icon--right arrow"
              :class="header.status == true ? 'arrowActive' : 'arrowUnactive'"
            >
              <arrow-right />
            </el-icon>
          </span>
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item
                ...
                :command="item.key"
                v-show="item.key != currentLocal.key"
                :divided="index > 0"
              >
                {{ item.name }}
              </el-dropdown-item>
        ...
        <el-col :span="24">
          ...
          >
            <el-sub-menu index="1">
              ...
              <el-menu-item index="1-4-1" disabled>{{
                $t("common.lending")
              }}</el-menu-item>
            </el-sub-menu>
            ...
            <el-sub-menu index="5">
              ...
              <el-menu-item>
                <a
                  target="_blank"
                  href="https://www.certik.com/projects/opendao"
                  >{{ $t("header.audit") }}</a
                >
              </el-menu-item>
            </el-sub-menu>
            <el-menu-item index="6">
              <el-icon><document /></el-icon>
              <span>
                <router-link to="/claim">Membership</router-link>
              </span>
            </el-menu-item>
...
<style lang="scss">
html:lang(de) .header-right-area {
  .header-language {
    margin-right: 20px;
  }
}
html:lang(rs) .header-right-area {
  .header-language {
    margin-right: 20px;
  }
}
